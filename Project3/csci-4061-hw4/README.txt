...
# Contributions:
  1. README.txt file: 
      * Alexandra Postolaki
  3. linked_list.c functions:
      * read_line - Alexandra Postolaki
      * traversal - Alexandra Postolaki
      * insert - Alexandra Postolaki
      * create_node - Matthew Vasby-Blumenshein

  4. main.c functions:
      * process_file - Matthew Vasby-Blumenshein
      * main: creating threads and joining - Yubin Hwang

  5. Debugging / Code Comments:
